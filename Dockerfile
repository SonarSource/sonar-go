...
FROM dev_base AS dev_no_custom_cert_image
...
USER root
# Additionally install gcc and musl. Static linking makes the Linux binary more portable, while almost not affecting its size (2.3 MB vs 2.4 MB in the initial experiments).
